...
let temporizadorRecordatorioQR = null; // Nuevo timer
...
async function onScanSuccess(decodedText, decodedResult) {
  // PRIORIDAD QR: Cancelar cualquier espera o mensaje anterior
  ...
  try {
    ...
    if (qrData.tipo === "INVITADO") {
      ...
      if (residenteAutoriza) {
        ...
        // 1. ABRIR PUERTA (Prioridad UX)
        console.log("Abriendo puerta para invitado...");
      ...
      if (vecinoValido) {
        ...
        // 1. ABRIR PUERTA
        console.log("Abriendo puerta para residente...");
        MQTTService.publish(CONFIG.MQTT_TOPICS.PUERTA, {
          accion: "ABRIR",
...
async function iniciarServicio() {
  ...
  // Se almacena en variable global para poder cancelarlo si detectamos QR antes
